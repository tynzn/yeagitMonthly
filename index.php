...
<html lang="zxx">
	<head>
		...
		<!-- Title Tag  -->
		<title>Yeagit - Affordable and flexible payment website developer</title>
		
		<!-- Favicon -->
		<link rel="icon" type="image/YEAGIT.png" href="img/YEAGITlogo.png">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-192598482-1">
</script>
<script>
  ...
  gtag('config', 'UA-192598482-1');
	...
	<body id="bg">
		...
		<header class="header">
					...
					<div class="row">
						<div class="col-lg-8 col-12">
							...
							<div class="top-contact">
								<div class="single-contact"><i class="fa fa-phone"></i>Phone: +(234) 07045207327</div> 
								<div class="single-contact"><i class="fa fa-envelope-open"></i>Email: yeagit.tech@gmail.com</div>	
						...
						<div class="col-lg-4 col-12">
							<div class="topbar-right">
								...
								-->													
								<div class="button">
									<a href="#" class="bizwheel-btn">Get a Quote</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="sidebar-popup">
				...
				<div class="single-content">
					<h4> Yeagit Core</h4>
					<p>Our core value is delivering quality website solutions to you!, Yes you!!! Our clients in the most flexible and affordable means possible  .</p>
					<!-- Social Icons 
					<ul class="social">
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="col-lg-7 col-md-8 col-12">
								<div class="welcome-text"> 
									<div class="hero-text"> 
										...
										<h1>Build Your brand online presence with Yeagit</h1>
										<div class="p-text">
					...
					<div class="col-12">
						<div class="section-title style2 text-center">
							<div class="section-top">
								<h1><span>Bonus</span><b>Satisfactory Gurantee</b></h1><h4>we offer a 30 day money back gurantee</h4>
							</div>
							<div class="section-bottom">
								<div class="text-style-two">
									<p>for the month you wish to stop your subscription to our service</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
						<div class="section-title default text-center">
							<div class="section-top">
								<h1><span>Designs</span><b>Make a choice</b></h1>
							</div>
							<div class="section-bottom">
								<div class="text">
									<p>Select the Design template you want used for your website</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="cbp-item business animation">-->
									...
									<div class="single-portfolio">
										<div class="portfolio-head overlay">
											<img src="/img/project/adio 1.jpg" alt="#">
											<a class="more" href="portfolio-single.html"><i class="fa fa-long-arrow-right"></i></a>
										</div>
										<div class="portfolio-content">
											<h4><a href="portfolio-single.html">Adio</a></h4>
											<p>Adio Website temlate</p>
										</div>
									</div>-->
		...
		<!-- Testimonials -->
		<section class="testimonials section-space" style="">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-9 col-12">
						<div class="section-title default text-left">
							<div class="section-top">
								<h1><b>clients Feedback</b></h1>
							</div>
							<div class="section-bottom">
						...
						<div class="testimonial-inner">
							<div class="testimonial-slider">
								...
								<div class="single-slider">
									...
									<p>This tech guys are super effective, delivered my portfolio on time and in absolute cool designs <strong>industry's standard</strong> Am so happy because they make it super seemless to own a website</p>
									<!-- Client Info -->
									<div class="t-info">
										<div class="t-left">
											<div class="client-head"><img src="https://via.placeholder.com/70x70" alt="#"></div>
											<h2>David O.M <span>Accountant/ Lagos, Nigeria</span></h2>
										</div>
										<div class="t-right">
								...
								<div class="single-slider">
									...
									<p>i needed a website to showcase my business online  <strong>And they delivered </strong> They have given my brand the confidence it needs in the market sace</p>
									<!-- Client Info -->
									<div class="t-info">
										<div class="t-left">
											<div class="client-head"><img src="https://via.placeholder.com/70x70" alt="#"></div>
											<h2>Ezekiel B.<span>Founder, Ezill Fashion</span></h2>
										</div>
										<div class="t-right">
											<div class="quote"><i class="fa fa-quote-right"></i></div>
										</div>
					...
					<div class="row">
								...
								<div class="logo">
									<div class="img-logo">
										<a class="logo" href="index.html">
											<img class="img-responsive" src="img/YEAGIT.png" alt="logo">
										</a>
									</div>
								</div>
								<div class="footer-widget-about-description">
									<p>Yeagit is focused on providing Coporate brand, Small businesses and Entreprenuers easy transition online with affordable and flexible payment </p>
								</div>	
								<div class="social">
									<!-- Social Icons -->
									<ul class="social-icons">
						...
						<div class="col-lg-3 col-md-6 col-12">	
							...
							<div class="single-widget footer_contact widget">	
								...
								<p>Our customer service line is on, reach us today</p>
								<ul class="address-widget-list">
									<li class="footer-mobile-number"><i class="fa fa-phone"></i>Phone: +(234) 7045207327</li>
									<li class="footer-mobile-number"><i class="fa fa-envelope"></i>yeagit.tech@gmail.com</li>
									<li class="footer-mobile-number"><i class="fa fa-map-marker"></i></li>
								</ul>
							</div>		
							<!--/ End Footer Contact -->						
						</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="copyright-content">
								<!-- Copyright Text -->
								<p>© Copyright <a href="#">Yeagit</a>. Design &amp; Development By <a target="_blank" href="#">YESG TECHNOLOGIES</a></p>
							</div>
						</div>
					</div>
				</div>
